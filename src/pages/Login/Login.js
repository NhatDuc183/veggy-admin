...
import { login, reset } from 'src/redux/auth/actions'
import RootNavigator from 'src/utils/navigate'
import styles from './Login.module.scss'
// import background from 'src/assets/images/login-background.jpg'
...
function Login() {
  ...
  return (
    <LoadingOverlay active={auth.loading} spinner text="Đang đăng nhập">
      ...
      <div
        className={cx('loginWrapper')}
        style={{
          backgroundImage: `url(https://i0.wp.com/thatnhucuocsong.com.vn/wp-content/uploads/2023/02/Hinh-anh-avatar-cute.jpg?ssl\u003d1)`,
        }}
      >
        <div className={cx('container')}>
          <div className={cx('rows')}>
            <div
              className={cx('col-lg-5', 'col-md-8', 'col-md-offset-4')}
              style={{ margin: '0 auto' }}
            >
              <form
