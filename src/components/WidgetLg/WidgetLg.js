...
import { handleDate, handleQuantity, upperCaseFirstLetter } from 'src/utils/commonFunc'
            ...
            {data.map((item) => {
              return (
                <tr key={item.id} className={cx('widgetLgTr')}>
                  ...
                  <td className={cx('widgetLgDate')}>
                    {handleQuantity(item.tuition, '.', ' VNĐ')}
                  </td>
          ...
          <tbody>
            ...
            {data.map((item) => {
              return (
                <tr key={item.id} className={cx('widgetLgTr')}>
                  <td>
                    <Link to={'/bills/' + item.id} className={cx('widgetLgUser')}>
